...
O proximo menor passo seguro e um manifesto externo de composicao multi-cena com `entryScene` e refs explicitas, ainda opt-in e sem mutar os contratos v1 existentes.
