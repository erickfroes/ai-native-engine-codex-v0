...
1. Continuar o hardening incremental de `Portable HTML Export v2` cobrindo explicitamente o caminho no-op de `spriteAnimation` em cenas sem `visual.sprite.animation`, mesmo com `assetManifestPath`, preservando `RenderSnapshot v1`, `Simple HTML Export v1` e o caminho default da Browser Demo.
