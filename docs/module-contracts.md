...
- nao integra `TileCollisionReport v1`; bloqueio por tile fica para pacote futuro;
- nao adiciona fisica completa, resolucao complexa, pathfinding, editor ou servidor.
