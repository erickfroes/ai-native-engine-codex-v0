...
2. Abrir `Browser UI Input Preview Hardening Matrix v1` como menor proximo passo seguro para consolidar regressao/performance do preview, mantendo `export-html-game` e `export-portable-html-game` passivos.
