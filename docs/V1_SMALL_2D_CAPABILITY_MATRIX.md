...
| UI System v1 visual opt-in | opt-in | `docs/UI_SYSTEM_V1.md`, `docs/BROWSER_PLAYABLE_DEMO_V1.md`, `docs/SIMPLE_HTML_EXPORT_V1.md`, `docs/PORTABLE_HTML_EXPORT_V2.md` | `inspect-ui-system`, `render-browser-demo --ui-system`, `export-html-game --ui-system`, `export-portable-html-game --ui-system` | `inspect_ui_system`, `render_browser_demo` com `uiSystem: true`, `export_html_game` com `uiSystem: true`, `export_portable_html_game` com `uiSystem: true` | `ui-system-*`, `browser-playable-demo-*`, `simple-html-export-v1`, `portable-html-export-v2`, `mcp-server` | Overlay DOM passivo em screen-space, derivado de `UiSystemReport v1`; `scenes/ui-production-screens.scene.json` cobre telas pequenas sem substituir HUD Lite. |
