...
Audio Lite v1 e Sprite Animation v1 foram entregues como incrementos diagnosticos pos-checkpoint. O proximo pacote recomendado e UI system/prefab system V2 conforme roadmap.
