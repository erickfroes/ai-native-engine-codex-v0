...
- Render SVG, SVG Demo HTML, Canvas2D Demo, Simple HTML Export e Portable HTML Export preservam essa falha previsivel quando carregam cenas por path; nas superficies sem MCP dedicado, a cobertura fica em runtime/CLI.
