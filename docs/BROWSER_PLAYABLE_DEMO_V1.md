...
- mostra uma area estatica de instrucoes e um HUD minimo com a posicao atual do rect controlavel;
...
- o botao `Reset position` restaura o rect controlavel para a posicao inicial do snapshot e redesenha o canvas;
