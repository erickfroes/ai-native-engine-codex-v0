...
test('inspect-prefab-usage-v2 fails predictably for unsafe prefab path references', () => {
  const result = runCli(['inspect-prefab-usage-v2', unsafePrefabPathsScenePath, '--json']);
