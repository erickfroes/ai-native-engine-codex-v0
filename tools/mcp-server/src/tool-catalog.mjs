export const toolCatalog = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        assetManifestPath: {
          type: 'string',
          description: 'Optional repository-relative or absolute path to an Asset Manifest v1 JSON file for asset-backed Canvas2D sprite loading.'
        }
      },
      additionalProperties: false
    }
  ...
  },
  {
    ...
    title: 'Inspect UI Navigation Focus',
    description: 'Build UiNavigationFocusReport v1 from UiSystemReport v1 without mutating ui.screen or runtime state.',
    inputSchema: {
      type: 'object',
      required: ['path'],
      properties: {
